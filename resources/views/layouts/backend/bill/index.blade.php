            ...
            <div class="col-md-12">
                <table id="myTable" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting col-md-2">Email</th>
                        <th class="sorting col-md-1">Trạng thái</th>
                        <th class="sorting col-md-2">Ghi chú</th>

                        <th class="sorting col-md-1" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="">Action</th>
                        <!-- <th class="sorting col-md-1" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="">Xóa</th></tr> -->
                    </thead>
                    <tbody>
                        @foreach($customers as $customer)
                            <tr>
                                ...
                                <td><a href="{{ url('admin/bill')}}/{{ $customer->id }}/edit">Detail</a></td>
                                <!-- <td>
